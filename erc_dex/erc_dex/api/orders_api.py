...
class OrdersApi(object):
    ...
    def get_orders(self, **kwargs):  # noqa: E501
        ...
        :param str maker_asset_type: Maker asset type (only ERC20 supported)
        :param str taker_asset_type: Taker asset type (only ERC20 supported)
        :param str pair:
    ...
    def get_orders_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['open', 'page', 'per_page', 'exchange_address', 'fee_recipient_address', 'taker_asset_data', 'maker_asset_data', 'sender_address', 'trader_asset_data', 'trader_address', 'taker_asset_address', 'taker_address', 'maker_asset_address', 'maker_address', 'maker_asset_type', 'taker_asset_type', 'pair']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'maker_address' in params:
            query_params.append(('makerAddress', params['maker_address']))  # noqa: E501
        if 'maker_asset_type' in params:
            query_params.append(('makerAssetType', params['maker_asset_type']))  # noqa: E501
        if 'taker_asset_type' in params:
            query_params.append(('takerAssetType', params['taker_asset_type']))  # noqa: E501
        if 'pair' in params:
